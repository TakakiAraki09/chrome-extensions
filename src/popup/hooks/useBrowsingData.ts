...
import { InterestScore, BrowsingActivity, HistoryItem, ViewMode, TimeRange } from '../types'
...
export const useBrowsingData = (viewMode: ViewMode, timeRange: TimeRange) => {
  ...
  const [browsingActivities, setBrowsingActivities] = useState<BrowsingActivity[]>([])
